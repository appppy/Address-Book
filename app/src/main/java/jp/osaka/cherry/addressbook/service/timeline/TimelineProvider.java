...
import static jp.osaka.cherry.addressbook.service.timeline.TimelineColumns.PATH;
...
public class TimelineProvider extends ContentProvider {
     ...
     * @serial Authority
     */
    public static final String AUTHORITY = "jp.osaka.cherry.addressbook.timeline.timelineprovider";
     ...
     */
    private TimelineHelper mDbHelper;
    ...
    public boolean onCreate() {
        mDbHelper = new TimelineHelper(getContext());
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        if (sUriMatcher.match(uri) == HISTORY) {
            insertTable = TABLE;
            contentUri = TimelineColumns.CONTENT_URI;
        } else {
            throw new IllegalArgumentException("Unknown URI " + uri);
        }
