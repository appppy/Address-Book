...
import jp.osaka.cherry.addressbook.databinding.ActivityUrlAdmobBinding;
import jp.osaka.cherry.addressbook.databinding.ActivityUrlBinding;
 ...
 * URL一覧画面
 */
public class UrlActivity extends BaseAdmobActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BuildConfig.DEBUG) {
            ...
            ActivityUrlAdmobBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_url_admob);
            mToolbar = binding.toolbar;
            mDrawerLayout = binding.drawerLayout;
            mNavigationView = binding.navView;
            mCoordinatorLayout = binding.coordinatorLayout;
    ...
    private void updateTitle(ArrayList<SimpleAsset> collection) {
        ...
        if (collection.isEmpty()) {
            sb.append(this.getString(R.string.url));
        } else {
            sb.append(this.getString(R.string.url)).append("  ").append(collection.size());
        }
    ...
    public ArrayList<SimpleAsset> toList(Collection<SimpleAsset> collection) {
        ...
        for (SimpleAsset asset : collection) {
            switch (asset.content) {
                ...
                default: {
                    if(!asset.url.equals(INVALID_STRING_VALUE)) {
